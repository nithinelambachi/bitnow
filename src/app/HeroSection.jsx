...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="w-full bg-[linear-gradient(180deg,#091c22_0%,#091c2200_50%,#091c22_100%)] relative overflow-hidden">
      <div 
              ...
              <div className="flex flex-col justify-start items-end w-full lg:w-[92%]">
                ...
                >
                  Ultrices ut etiam vulputate ante congue jokichn na
                   <span 
                  className="pl-2 text-[32px] sm:text-[48px] md:text-[56px] lg:text-[63px] font-normal leading-[45px] sm:leading-[67px] md:leading-[78px] lg:leading-[89px] text-[#5e81ff] capitalize mt-[-40px] sm:mt-[-60px] lg:mt-[-80px] "
                  style={{ 
